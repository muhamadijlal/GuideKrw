...
<section id="home" class="pt-16 dark:bg-dark">
  <div class="w-full">
    <div class="overflow-hidden relative h-96 lg:h-screen">
...
<section id="fnb" class="pt-36 pb-32 dark:bg-dark">
  <div class="container">
    ...
    <div class="w-full flex justify-end">
      <p class="text-base block font-semibold text-primary hover:text-dark dark:text-white dark:hover:text-primary cursor-pointer">
        <a href="#">Show more ></a>
      </p>
    </div>
  </div>
