    ...
    <div class="container">
      <div class="w-full px-4">
        ...
        <div class="flex flex-wrap items-center py-4 lg:hidden">
          ...
          <span class="block py-1 px-3 mx-1 my-1 bg-slate-300 text-slate-500 text-xs">Inovation</span>
          <span class="block py-1 px-3 mx-1 my-1 bg-slate-300 text-slate-500 text-xs">Popular</span>
          <span class="block py-1 px-3 mx-1 my-1 bg-slate-300 text-slate-500 text-xs">Covid-19</span>
          <span class="block py-1 px-3 mx-1 my-1 bg-slate-300 text-slate-500 text-xs">Health</span>
        </div>
        <div class="w-full py-8">
          <div class="flex items-center mb-5">
            <img src="https://source.unsplash.com/300x300?person" alt="person" class="rounded-full lg:h-12 lg:w-12 h-7 w-7">
            <h3 class="text-base lg:text-2xl font-semibold text-dark hover:text-primary truncate  ml-2 lg:ml-5">Muhamad Haidar Ijlal</h3>
          </div>
          <div class="w-full mb-10">
            <p class="text-lg lg:text-4xl font-bold">Judul Judul Judul Judul Judul Judul Judul Judul Judul Judul Judul Judul Judul Judul Judul Judul </p>
          </div>
        ...
        <div class="flex items-center">
          <div class="w-1/2 flex">
            <div id="like" class="flex items-center mx-1">
              ...
              <p class="px-2 text-xs text-slate-300">1000K</p>
            </div>
            <div id="comment" class="flex items-center mx-1">
              ...
              <p class="px-2 text-xs text-slate-300">512</p>
            </div>
            <div id="share" class="flex items-center mx-1">
              ...
              <p class="px-2 text-xs text-slate-300">100+</p>
            </div>
          </div>
