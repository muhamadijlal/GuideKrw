  ...
  <div class="pt-16 pb-12 lg:pb-32 ">
    <div class="w-full relative h-96 lg:h-screen overflow-hidden bg-yellow-200">
      ...
      <div class="w-full py-6 bottom-10 top-28 lg:top-48 absolute px-4">
        <h1 class="text-white font-extralight text-2xl lg:text-8xl text-center">Food & Baverages</h1> 
...
<section class="dark:bg-dark">
  <div class="container pt-32 pb-36">
    <div class="w-full px-4">
      <div class="px-4 mb-20">
        <h1 class="text-4xl text-dark font-bold dark:text-white">Menus</h1>
      </div>
      <div class="w-full flex flex-no-wrap scrolling h-[450px] items-start overflow-x-scroll py-8 gap-6 lg:gap-7">
        <div class="card flex-none w-[160px] h-72 lg:w-[200px] lg:h-80">
          <div class="w-full h-56 lg:h-64 rounded-xl overflow-hidden">
            <img src="https://source.unsplash.com/176x224?food" alt="" class="w-full h-56 lg:h-64">
          </div>          
          <div class="w-full py-3">
            <h1 class="text-base font-bold text-white mb-2">Daangeuun</h1>
          ...
          <div class="w-full">
            <span class="text-sm flex-end text-secondary">Food's</span>
          </div>
        </div>         
        <div class="card flex-none w-[160px] h-72 lg:w-[200px] lg:h-80">
          <div class="w-full h-56 lg:h-64 rounded-xl overflow-hidden">
        ...
        <div class="card flex-none w-[160px] h-72 lg:w-[200px] lg:h-80">
          <div class="w-full flex h-full mx-auto rounded-lg">
            <a href="#" class="mx-auto my-auto text-white">
              <p class="text-sm text-white font-semibold hover:text-primary">View More
