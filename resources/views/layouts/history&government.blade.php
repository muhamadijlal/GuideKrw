...
@section('title','History & Government')
  ...
  <div class="pt-16 pb-12 lg:pb-32 ">
    <div class="w-full relative h-96 lg:h-screen overflow-hidden bg-yellow-200">
      ...
      <div class="w-full py-6 bottom-10 top-28 lg:top-48 absolute px-4">
        <h1 class="text-white font-extralight text-2xl lg:text-8xl text-center">History & Government</h1> 
        {{-- <p class="text-white font-semibold text-bse lg:text-2xl text-center">History & Government</p> --}}
