    ...
    <section class="pt-36 pb-32">
      <div class="container">
        ...
        <div class="w-full px-4">
          <h1 class="text-2xl lg:text-4xl text-dark font-bold py-12">Search Result</h1>
          <div class="flex flex-wrap">
            <div class="w-full px-4 mb-3 lg:w-1/3">            
              <div class="w-full rounded-lg overflow-hidden">
                ...
                <div class=" py-4">
                  <h1 class="text-2xl lg:text-4xl font-bold py-4 text-dark">Kopi Uwak Coffe & Roastery</h1>
                  <p class="text-sm lg:text-base text-secondary py-2"><span class="text-dark font-semibold text-sm">Alamat :</span> Ruko Teraz block IX-C no. 57, Galuh Mas, Karawang, Jawa Barat</p>
                  <p class="text-sm lg:text-base text-secondary py-2"><span class="text-dark font-semibold text-sm">Jam :</span> 13:00 - 22:00 WIB</p>
                  <p class="text-sm lg:text-base text-secondary py-2"><span class="text-dark font-semibold text-sm">Telepon :</span> 0811-763-425</p>                  
